...
void main() {
  group('NativeScripts -', () {
    test('serialize', () {
      final t0 = ScriptPubkey(
          keyHash: 'ad7a7b87959173fc9eac9a85891cc93892f800dd45c0544128228884');
      final t1 = RequireTimeBefore(slot: 12345678);
      final t2 = RequireTimeAfter(slot: 87654321);
      final t3 = ShelleScriptAtLeast(amount: 1, scripts: [t0, t1, t2]);
      final t4 = ShelleScriptAtLeast(amount: 1, scripts: [t1, t2]);
      final scripts = [
        t0,
        ShelleScriptAtLeast(amount: 2, scripts: [t0, t1, t2, t3, t4]),
        ScriptAll(scripts: [t1, t2, t3, t4]),
        ScriptAny(scripts: [t1, t2, t3, t4])
      ];
      for (Script script1 in scripts) {
        final bytes1 = script1.serialize;
        CborValue val1 = cbor.decode(bytes1);
        print(const CborJsonEncoder().convert(val1));
        final script2 = NativeScript.fromCbor(list: val1 as CborList);
  ...
  group('ScriptAddresses -', () {
    test('serialize', () {
      final input1 = ShelleyTransactionInput(
          ...
          index: 1);
      final bytes1 = cbor.encode(input1.toCborList());
      CborValue val1 = cbor.decode(bytes1);
      print(const CborJsonEncoder().convert(val1));
    ...
    test('Deserialization', () {
      ...
      final ShelleyTransaction tx2 =
          ShelleyTransaction.deserializeFromHex(txHex);
    ...
    test('Serialize Transaction with Metadata', () {
      ...
      //metadata
      // final metadataMap = cbor.CborValue.builder()
      //   ..writeInt(1978) //key
      ...
      //   ..addBuilderOutput((cbor.CborValue.builder()
      //         ..writeInt(401) //key
      //         ..writeString('401str') //value
      //         ..writeString('hello') //key
      //         ..writeString('hellovalue')) //value
      //       .getData());
      // final metadata = CBORMetadata(cbor.CborValue.builder()
      ...
      final ShelleyTransaction tx = ShelleyTransaction(
          body: body, witnessSet: null, metadata: null); //metadata
      final txHex = tx.toCborHex;
      print(txHex);
      const expectedHex =
    ...
    //   // Get our map builder
    //   final mapBuilder = cbor.CborValue.builder();
