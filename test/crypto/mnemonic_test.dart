...
void main() {
  ...
  group('mnemonic -', () {
    test('entropy to seed', () {
      ...
      final entropy1 = mnemonicToEntropyHex(
          mnemonic: testMnemonic1, loadWordsFunction: loadEnglishMnemonicWords);
    ...
    test('entropy vs mnemonic', () {
      final mnemonic1 =
          'damp wish scrub sentence vibrant gauge tumble raven game extend winner acid side amused vote edge affair buzz hospital slogan patient drum day vital'
              .split(' ');
      final entropy1 = mnemonicToEntropyHex(
          mnemonic: mnemonic1, loadWordsFunction: loadEnglishMnemonicWords);
      final mnemonic2 = entropyHexToMnemonic(
    ...
    test('vectors with passphrase', () {
      for (List<String> vector in _vectors) {
        ...
        final mnemonic1 = vector[1].split(' ');
        final seed1 = vector[2];
        final entropy2 = mnemonicToEntropyHex(
            mnemonic: mnemonic1, loadWordsFunction: loadEnglishMnemonicWords);
        expect(mnemonic1, equals(mnemonic1));
