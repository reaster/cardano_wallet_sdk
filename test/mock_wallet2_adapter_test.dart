...
import 'test_wallet_adapter.mocks.dart';
...
Response<TxContentUtxo> txContentUtxo(String txId) {
  ...
  switch (txId) {
    case tx1:
      json =
          '["inputs",[["address","addr_test1qzxs6rwvj65sgylxh27y6ljdys8vr22z46s27k3m7fsaqcpxngwdkqgqcvjtzmz624d6efz67ysf3597k24uyzqg5ctsh478e0","amount",[["unit","lovelace","quantity","1000000000"]]]],"outputs",[["address","addr_test1qputeu63ld6c0cd526w90ry2r9upc5ac8y3zetcg85xs5l924fm4c4hnud6cw53zj8v48kdwmeykn0knf74ag68tmf9sutu8kq","amount",[["unit","lovelace","quantity","100000000"]]],["address","addr_test1qp680xknwamupzcuf9jwngrr6k69vzuwyjs87z583k74gafxngwdkqgqcvjtzmz624d6efz67ysf3597k24uyzqg5ctsx5kkgg","amount",[["unit","lovelace","quantity","899831199"]]]]]';
      break;
    case tx2:
      json =
