...
void main() {
  ...
  group('ADAFormattter - ', () {
    test('currency', () {
      ...
      logger.info(formatter.format(120));
      logger.info(formatter.format(120000));
      logger.info(formatter.format(120000000));
      logger.info(formatter.format(120000000000));
      logger.info(formatter.format(120000000000000));
      logger.info(formatter.format(120000000000000000));
      logger.info(formatter.format(9000000000000000000));
